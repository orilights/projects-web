...
<template>
  <div class="group relative w-[274px] cursor-pointer">
      ...
      <div class="flex h-full cursor-pointer flex-col justify-between rounded-xl border bg-white p-4 transition-all duration-300 hover:shadow-md">
        <div>
          <div v-if="data.cover" class="mb-1 h-[135px] w-[240px] overflow-hidden rounded-lg border bg-blue-50">
            <img :src="data.cover" alt="project cover image" class="w-full transition-transform duration-500 group-hover:scale-110">
          </div>
        ...
        <div class="mt-2 flex items-center gap-2">
          <a v-if="data.link?.website" :href="data.link.website" target="_blank" class="text-gray-500 transition-colors hover:text-black">
            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 512 512" class="size-5">
          ...
          <a v-if="data.link?.github" :href="data.link.github" target="_blank" class="text-gray-500 transition-colors hover:text-black">
            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 496 512" class="size-5">
          ...
          <span v-if="data.lastUpdated" class="ml-auto rounded-full bg-slate-200 px-2 py-0.5 text-sm">
            最近
          </span>
        </div>
      </div>
    </a>
    <div class="pointer-events-none absolute left-0 top-0 size-full scale-110 rounded-xl border opacity-0 transition-all duration-300 group-hover:scale-100 group-hover:border-gray-500 group-hover:opacity-100" />
  </div>
</template>
